      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-4 font-sans">AyuBuild Hub</h3>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm max-w-xs leading-relaxed">
              The smartest way to build your next gaming PC. We combine real-time pricing, compatibility checking, and performance data to help you build with confidence.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <li><a href="#" className="hover:text-emerald-500 transition-colors">Compatibility Guide</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-semibold text-zinc-900 dark:text-white mb-4 text-sm uppercase tracking-wider">Connect</h4>
            <div className="flex gap-4">
              <a href="#" className="text-zinc-400 hover:text-emerald-500 transition-colors"><Twitter className="w-5 h-5" /></a>
              <a href="#" className="text-zinc-400 hover:text-emerald-500 transition-colors"><Github className="w-5 h-5" /></a>
              <a href="#" className="text-zinc-400 hover:text-emerald-500 transition-colors"><Instagram className="w-5 h-5" /></a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-zinc-200 dark:border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-zinc-500 dark:text-zinc-500">
          <p>&copy; {new Date().getFullYear()} AyuBuild Hub. All rights reserved.</p>
